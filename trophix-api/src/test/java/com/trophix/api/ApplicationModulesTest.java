...
class ApplicationModulesTest {
    ...
    private static final Set<String> KNOWN_VIOLATIONS = Set.of(
            ...
            "Module 'admin' depends on non-exposed type com.trophix.api.auth.application.ports.out.RoleRepositoryPort within module 'auth'!",
            "Module 'admin' depends on non-exposed type com.trophix.api.auth.model.Role within module 'auth'!",
            ...
            "Module 'forums' depends on non-exposed type com.trophix.api.shared.infrastructure.security.AuthenticatedUser within module 'shared'!",
            ...
            "Module 'guides' depends on non-exposed type com.trophix.api.shared.infrastructure.security.AuthenticatedUser within module 'shared'!",
            ...
            "Module 'shared' depends on non-exposed type com.trophix.api.auth.application.ports.out.TokenValidatorPort within module 'auth'!",
            "Module 'shared' depends on non-exposed type com.trophix.api.auth.application.ports.out.TokenValidatorPort$TokenClaims within module 'auth'!",
            "Module 'shared' depends on non-exposed type com.trophix.api.auth.model.Role within module 'auth'!",
            "Module 'shared' depends on non-exposed type com.trophix.api.trophies.application.ports.in.SyncGameTrophiesUseCase within module 'trophies'!",
            "Module 'shared' depends on non-exposed type com.trophix.api.users.application.async.UserProfileSyncExecutor within module 'users'!",
            "Module 'shared' depends on non-exposed type com.trophix.api.users.application.ports.out.UserRepository within module 'users'!",
            "Module 'shared' depends on non-exposed type com.trophix.api.users.model.User within module 'users'!",
            ...
            "Module 'users' depends on non-exposed type com.trophix.api.auth.infrastructure.adapter.out.RoleJpaEntity within module 'auth'!",
            "Module 'users' depends on non-exposed type com.trophix.api.auth.infrastructure.adapter.out.RoleSpringDataRepository within module 'auth'!",
            "Module 'users' depends on non-exposed type com.trophix.api.auth.model.Role within module 'auth'!",
